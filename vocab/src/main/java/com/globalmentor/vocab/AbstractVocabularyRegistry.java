 ...
 */
public abstract class AbstractVocabularyRegistry extends MapDecorator<URI, String> {
	...
	public AbstractVocabularyRegistry() {
	 ...
	 */
	public AbstractVocabularyRegistry(final Map<URI, String> map) {
