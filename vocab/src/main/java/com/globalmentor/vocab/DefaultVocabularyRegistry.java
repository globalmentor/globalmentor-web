 ...
 */
public abstract class DefaultVocabularyRegistry extends MapDecorator<URI, String> {
	...
	public DefaultVocabularyRegistry() {
	 ...
	 */
	public DefaultVocabularyRegistry(final Map<URI, String> map) {
