 ...
 * package that have the same name as the public ID, with illegal characters replaced with "^XX", where "XX" is a hex code. For example, the entity public ID
 * "-//W3C//DTD XHTML 1.1//EN" would be stored in this package under the filename "-^2F^2FW3C^2F^2FDTD XHTML 1.1^2F^2FEN".
 * <p>
