...
public class JavaScript {
	...
	/**
	 * Returns the name of an object method: <code><var>object</var>.<var>method</var>()</code>
	 * @param object The name of the object.
	 * @param method The name of the method.
	 * @param parameters The method parameters.
	 */
	...
	/**
	 * Returns a negation: <code>!<var>expression</var></code>
	...
	/**
	 * Returns a string representing an <code>if()</code> block: <code>if(<var>testExpression</var>){<var>thenBlock</var>}</code>
	...
	/**
	 * Returns a string representing an <code>if()</code> block: <code>if(<var>testExpression</var>){<var>thenBlock</var>}else{<var>elseBlock</var>}</code>
	 * @param testExpression The expression to test.
	 * @param thenBlock The block to execute if the test evaluates to <code>true</code>.
	 * @param elseBlock The block to execute if the test evaluates to <code>false</code>, or <code>null</code> if there should be no else block.
	 * @return A string representing an if statement.
	 */
