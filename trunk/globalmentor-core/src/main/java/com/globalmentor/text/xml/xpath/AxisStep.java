...
public class AxisStep implements Step {
	...
	/**
	 * @return A string representation of the location step in the form "axis::nodeTest", or "root" for the special location step containing "/" as an axis.
	 */
	public String toString() {
		if(getAxis().equals(ROOT)) //if this is the special "/" location step
			return "root"; //return "root"
		else
			//if this is a normal location step
