...
public abstract class XMLCSSValue implements org.w3c.dom.css.CSSValue//TODO fix, Cloneable
{
	...
	/**
	 * Sets the node type of this object. This is not a DOM function, but a protected function that allows derived objects to set the node type.
	 * @param nodeType The new node type. TODO do we want to delete this, and make this have to be specified when the node is created?
	 */
	...
	/** The priority (e.g. "important") of this value. */
	//TODO it would probably be best to have a separate XMLProperty class name/value/priority similar to XMLAttribute.
	private String Priority = "";

	/**
	 * @return The priority (e.g. "important") of the value. In this implementation this property can only has package access because it may be relocated.
	 */
	String getPriority() {
		return Priority;
	}
	...
	/**
	 * Sets the priority (e.g. "important") of the value. In this implementation this property can only has package access because it may relocated.
