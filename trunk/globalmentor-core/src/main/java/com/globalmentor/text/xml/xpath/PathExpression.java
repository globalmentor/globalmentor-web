...
public class PathExpression implements Iterable<Step> {
	 ...
	 * @param stepStrings If step strings are being provided, the step strings to be compiled into a path expression, starting with the second step string (the
	 *          first is represented by the path expression).
	 */
