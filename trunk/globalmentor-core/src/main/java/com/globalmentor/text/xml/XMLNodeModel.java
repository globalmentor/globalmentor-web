...
public class XMLNodeModel<N extends Node> extends URIAccessibleModel {
	 ...
	 * @param newXML The XML information being modeled, or <code>null</code> if there is no XML information.
	 */
	...
	/**
	 * XML constructor.
	 * @param xml The XML informatoin being modeled, or <code>null</code> if there is no XML information.
	 */
