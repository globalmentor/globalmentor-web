...
public class XMLDOMExceptionResources extends ListResourceBundle {
	...
	static final Object[][] contents = {
			...
			//error codes
			{ XMLDOMException.RESOURCE_PREFIX + XMLDOMException.INDEX_SIZE_ERR,
					"(Index Size Error) The index or size {0} is negative or greater than the allowed value." },
			{ XMLDOMException.RESOURCE_PREFIX + XMLDOMException.DOMSTRING_SIZE_ERR,
					"(DOMString Size Error) The specified range of text with length {0} cannot fit into a DOMString." },
			{ XMLDOMException.RESOURCE_PREFIX + XMLDOMException.HIERARCHY_REQUEST_ERR,
					"(Hierarchy Request Error) The node \"{0}\" cannot be inserted at this location in the hierarchy." },
			...
			{ XMLDOMException.RESOURCE_PREFIX + XMLDOMException.NO_MODIFICATION_ALLOWED_ERR,
					"(No Modification Allowed) The node \"{0}\" is read-only and cannot be modified." },
			{ XMLDOMException.RESOURCE_PREFIX + XMLDOMException.NOT_FOUND_ERR, "(Not Found) The node \"{0}\" does not exist in this context." },
			{ XMLDOMException.RESOURCE_PREFIX + XMLDOMException.NOT_SUPPORTED_ERR,
					"(Not Supported) This object or operation \"{0}\" is not supported in this implementation." },
			...
			{ XMLDOMException.RESOURCE_PREFIX + XMLDOMException.INVALID_ACCESS_ERR,
					"(Invalid Access) The parameter or operation \"{0}\" is not supported by the underlying object." } };
}
