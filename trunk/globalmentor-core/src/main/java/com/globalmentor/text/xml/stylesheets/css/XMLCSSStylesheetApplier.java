...
public class XMLCSSStylesheetApplier extends AbstractXMLCSSStylesheetApplier<Document, Element> implements CSSStyleManager //TODO do we really need this style manager interface? 
{
	...
	/**
	 * The map of styles, each keyed to an element. The weak map allows the styles to be garbage-collected once the corresponding element is no longer used.
	 */
	...
	protected Map<Element, CSSStyleDeclaration> getCSSStyleMap() {
		return cssStyleMap;
	}
	 ...
	 * </p>
	 * <p>
	 * This implementation delegates to the object provided at construction.
	 * </p>
