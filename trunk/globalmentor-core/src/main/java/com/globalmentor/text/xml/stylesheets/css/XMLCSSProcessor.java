...
public class XMLCSSProcessor implements URIInputStreamable {
	...
	/**
	 * Skips all CSS whitespace characters, and returns the number of characters skipped. Resets peeking.
	...
	/**
	 * Skips all CSS whitespace characters, and returns the number of characters skipped. No exception is thrown if the end of the file is reached. Resets
	 * peeking.
	 * @param reader The reader from which to retrieve characters.
	 * @throws IOException Thrown when an i/o error occurs.
	 * @return The number of characters skipped.
	...
	/**
	 * Skips all CSS whitespace characters and XML comment starts/stops, and returns the number of characters skipped. Resets peeking.
	 * @param reader The reader from which to retrieve characters.
	 * @throws IOException Thrown when an i/o error occurs.
	 * @throws ParseEOFException Thrown when the end of the input stream is reached unexpectedly.
	 * @return The number of characters skipped.
	...
	*/
	...
	/**
	 * Skips all CSS whitespace characters and XML comment starts/stops, and returns the number of characters skipped. No exception is thrown if the end of the
	 * file is reached. Resets peeking.
	 * @param reader The reader from which to retrieve characters.
	 * @throws IOException Thrown when an i/o error occurs.
	 * @return The number of characters skipped.
	 */
	...
	*/
	...
	/**
	 * Returns an input stream from given URI. This function is used when we're acting as our own <code>URIInputStreamable</code>.
	...
	/**
	 * Parses an input stream that supposedly begins with a CSS value. The entire value is read and parsed up to whitespace, the declaration separator (;), or the
	 * end-of-rule-group separator (}). No end-of-file exception is thrown. The returned string value will not have been verified; it is assumed that this value
	 ...
	 * @param reader The reader from which to retrieve characters. //G**del if not needed @propertyName The name of the property to which the value will be
	 *          assigned, or //TODO del if not needed <code>null</code> if the property name is not known.
		...
		while(true) { //we'll keep reading selectors until we find the block of rules, which, when finished, will return from this function
			...
			if(reader.peekChar() == RULE_GROUP_START_CHAR) { //if the next character to be read is the start of the group of rules
				...
				*/
				...
				//if this isn't the start of a group of rules, so this must have just been the separator between selectors
	 ...
	 * @param document The XML document that that contains stylesheet information. //TODO fix all this exception stuff
	 * @throws IOException Thrown when an i/o error occurs.
	 * @throws ParseUnexpectedDataException Thrown when an unexpected character is found.
	 * @throws ParseEOFException Thrown when the end of the input stream is reached unexpectedly.
	 */
	...
	/**
	 * Parses a stylesheet from the contents of a <code>Reader</code> with the given parent document.
	 * @param reader The source from which the information will be read.
	 * @param sourceObject The source of the data (e.g. a String, File, or URL).
	...
	/**
	 * Parses a stylesheet from the information in the given <code>Reader</code> The reader is left open.
