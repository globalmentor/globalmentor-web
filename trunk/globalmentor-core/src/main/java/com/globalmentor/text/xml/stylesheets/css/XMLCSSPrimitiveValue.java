...
public class XMLCSSPrimitiveValue extends XMLCSSValue implements org.w3c.dom.css.CSSPrimitiveValue//TODO fix, Cloneable
{
	...
	*/
	 ...
	 * @param stringType A string code, which can only be a string unit type (e.g. <code>CSS_URI</code>, <code>CSS_IDENT</code>, <code>CSS_INHERIT</code> and
	 *          <code>CSS_ATTR</code>).
	...
	/**
	 * Sets the unit type of the value. This is not a DOM function, but a protected function that allows derived objects to set the primitive type.
	...
	public String getCssText() {
		if(isFloatType(getPrimitiveType())) //if our value is a floating-point type
			...
			*/
			...
			//if it's anything else, assume it's a string TODO fix for other types, and don't assume here; perhaps return "" for unknown types
			return StringValue; //return our string value
	}

	/** The primitive value if this is a float-compatible value. */
	//TODO check about how best to store several types here
	private float FloatValue;

	/** The primitive value if this is a string-compatible value. */
	//TODO check about how best to store several types here
	private String StringValue = null;

	/** The primitive value if this is an RGB color value. */
	//TODO check about how best to store several types here
