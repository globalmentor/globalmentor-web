...
class XMLTag extends XMLNode {
	 ...
	 */
	public void setTagType(int newTagType) {
		TagType = newTagType;
	}
	...
	*/
	 ...
	 */
	public XMLNamedNodeMap getAttributeXMLNamedNodeMap() {
		return AttributeMap;
	...
	/**
	 * Sets the attributes for this element. This has package access so helper classes such as <code>XMLProcessor</code> can access this method.
