...
public class XMLEntity extends XMLNode implements org.w3c.dom.Entity {
	...
	*/
	 ...
	 * @param ownerDocument The document which owns this node.
	 * @param newName The name of the XML entity. //TODO fix @throws XMLInvalidNameException Thrown if the specified name is invalid.
	 */
	 ...
	 * @param value The value for this entity. //TODO fix @throws XMLInvalidNameException Thrown if the specified name is invalid.
	 */
	 ...
	 * @return <code>true</code> if this is a parameterEntity, or <code>false</code> if this is a general entity.
	 */
	 ...
	 * @param parameterEntity <code>true</code> if this is a parameter entity, or <code>false</code> if this is a general entity.
	 */
	void setParameterEntity(final boolean parameterEntity) {
		ParameterEntity = parameterEntity;
	}

	/**
	 * Returns whether or not this is an external entity by checking to see if getSystemID() is not <code>null</code>.
	...
	/**
	 * Returns whether or not this is a parsed entity by checking to see if getNotationName() is <code>null</code>.
	...
	/**
	 * @return The public identifier, or <code>null</code> if there is none. For the DOM version, see getPublicId().
	...
	/**
	 * @return The public identifier, or <code>null</code> if there is none. For the DOM version, see getSystemId().
	 * @see XMLDocumentType#getSystemId
	 * @see XMLDocumentType#getPublicID
	 */
	 ...
	 */
	void setNotationName(final String notationName) {
