...
/**
 * Definitions for XLink defined by the W3C at <a href="http://www.w3.org/TR/xlink/">XML Linking Language (XLink)</a>.
...
public class XLink {
	...
	/**
	 * Sets the <code>xlink:type</code> and <code>xlink:href</code> attributes of the given element.
