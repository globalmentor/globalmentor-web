...
public class XMLWellFormednessException extends XMLParseException {
	...
	/**
	 * Well-Formedness Constraint: PEs in Internal Subset In the internal DTD subset, parameter-entity references can occur only where markup declarations can
	 * occur, not within markup declarations. TODO fix Arguments: name of beginning tag, name of ending tag.
	 */
	...
	/**
	 * Well-Formedness Constraint: Legal Character Characters referred to using character references must match the production for Char. Arguments: Character
	 * reference string.
	 */
	public static final short LEGAL_CHARACTER = 5;

	/**
	 * Well-Formedness Constraint: Entity Declared In a document without any DTD, a document with only an internal DTD subset which contains no parameter entity
	 * references, or a document with "standalone='yes'", the Name given in the entity reference must match that in an entity declaration, except that well-formed
	 * documents need not declare any of the following entities: amp, lt, gt, apos, quot. Arguments: Character reference name.
	 */
	public static final short ENTITY_DECLARED = 6;

	/**
	 * Well-Formedness Constraint: Parsed Entity An entity reference must not contain the name of an unparsed entity. Arguments: Name of parsed entity.
	 */
	public static final short PARSED_ENTITY = 7;

	/**
	 * Well-Formedness Constraint: No Recursion A parsed entity must not contain a recursive reference to itself, either directly or indirectly. Arguments: Name
	 * of entity reference.
	 */
	public static final short NO_RECURSION = 8;

	/**
	 * Well-Formedness Constraint: In DTD Parameter-entity references may only appear in the DTD. This should never be used, because everywhere else besides the
	 * DTD parameter entity references are considered normal text. Arguments: Name of parameter entity reference.
	 */
	public static final short IN_DTD = 9;

	/**
	 * Well-Formedness Constraint: EOF The end of the file was unexpectedly encountered while parsing data. Arguments: Type of object being processed, name of
	 * object.
	 */
	public static final short EOF = 50;

	/**
	 * Well-Formedness Constraint: Unexpected Data Incorrect data was encountered. Arguments: String with expected data, string with data found.
	 */
	public static final short UNEXPECTED_DATA = 51;

	/**
	 * Well-Formedness Constraint: Invalid Character An invalid character was encountered. Arguments: The invalid character.
	 */
	public static final short INVALID_CHARACTER = 52;

	/**
	 * Well-Formedness Constraint: Invalid Name An invalid XML name was found. Arguments: The invalid name.
	 */
	public static final short INVALID_NAME = 53;

	/**
	 * Well-Formedness Constraint: Invalid PI Target An invalid XML processing instruction target was found. Arguments: The invalid processing instruction target.
	 */
	public static final short INVALID_PI_TARGET = 54;

	/**
	 * Well-Formedness Constraint: Invalid Format Invalid format or UTF-16 encoding was used without the Byte Order Mark #xFEFF.
	 */
	public static final short INVALID_FORMAT = 55;

	/**
	 * Well-Formedness Constraint: Invalid encoding. The character encoding was unrecognized or an encoding besides UTF-8 was used with no "encoding" attribute.
