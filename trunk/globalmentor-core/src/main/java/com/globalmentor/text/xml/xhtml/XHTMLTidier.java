...
//TODO fix											|| lastPageBreakType<0) //TODO testing
									{
										...
										//  as are book titles)
										if(headingType<=Prose.MAX_SIGNIFICANT_HEADING || elementIndex>lastAttemptedPageBreakElementIndex+2 || lastAttemptedPageBreakElementIndex<=0 || isLastPageBreakHeadingFixed || isBookTitleHeading)
										{
