 ...
 * An RDF data model.
 * <p>
 * The data model should be used to create resources, as it keeps a list of registered resource factories based upon resource type namespaces.
 * </p>
 * <p>
 * The RDF data model itself is a resource factory for the default RDF resources such as bags, but registering a resource factory for the RDF namespace will
 * override this default behavior.
 * </p>
 * <p>
 * The RDF data model itself is a typed literal factory for the default RDF datatypes (currently XMLLiteral), but registering a resource factory for the RDF
 * namespace will override this default behavior.
 * </p>
 * <p>
 * The RDF data model by default registers a factories that handle the following datatype namespaces:
 * </p>
 * <dl>
 * <dt>XML Schema</dt>
...
public class RDF //TODO special-case rdf:nil list resources so that they are not located, but a different instance is created for each one, to make RDFListResource convenience methods work correctly 
{
	...
	/**
	 * Registers a typed literal factory to be used to create literals with a datatype from the specified namespace. If a type literal factory is already
	 * registered for this namespace, it will be replaced.
	 * @param datatypeNamespaceURI The namespace of the datatype for which this factory should be used to create typed literals.
	 * @param factory The typed literal factory that will be used to create literals with datatypes from this namespace.
	 */
	...
	/**
	 * Removes the typed literal factory being used to create literals with a datatype from the specified namespace. If there is no typed literal factory
	 * registered for this namespace, no action will be taken.
	 * @param datatypeNamespaceURI The namespace of the datatype for which this factory should be used to create typed literals.
	 */
	...
	/**
	 * Retrieves a typed literal factory to be used for creating literals with a datatype from the specified namespace URI.
	 * <p>
	 * To accommodate vocabularies with different namespace URI mapping rules (such as RDF and and XML Schema) which result in different namespace
	 * representations, if the namespace URI ends in a fragment separator ('#') and no factory is found, an attempt is made to look up a factory using the
	 * namespace URI without that trailing fragment separator character.
	 * </p>
	 * @param datatypeNamespaceURI The namespace of the datatype for which a typed literal factory should be returned.
	 * @return The factory registered for this datatype namespace, or <code>null</code> if there is no factory registered for this datatype namespace.
	 */
	...
	/**
	 * Adds a resource to the data model. If the resource is already in the model, no action occurs.
	...
	/**
	 * @return A read-only iterable of resources appropriate for appearing at the root of a hierarchy, such as an RDF tree or an RDF+XML serialization.
	 */
	...
	/**
	 * Returns a read-only iterable of resources appropriate for appearing at the root of a hierarchy, such as an RDF tree or an RDF+XML serialization. The
	...
	/**
	 * Determines if the given resource is appropriate for appearing at the root of a hierarchy, such as an RDF tree or an RDF+XML serialization.
	 * <p>
	...
	/**
	 * Retreives a resource from the data model based upon a URI. If no such resource exists, one will be created and added to the data model.
	...
	/**
	 * Retrieves a resource from the data model based upon the reference URI of the resource. If no such resource exists, one will be created and added to the
	 * data model. The given URI will be used to locate a resource factory to create the resource, and that type URI will be added as a type property. If the
	 * resource already exists, no checks are performed to ensure that the existing resource is of the requested type.
	 * @param referenceURI The reference URI of the resource to retrieve.
	...
	/**
	 * Retrieves a resource from the data model based upon the reference URI of the resource. If no such resource exists, one will be created and added to the
	 * data model. The given type serialization XML namespace URI and local name will be used to locate a resource factory to create the resource, and the type
	...
	/**
	 * Creates a general resource with the a reference URI based upon an XML namespace URI and an XML local name, and stores the resource in this RDF data model.
	...
	/**
	 * Creates a general resource with the specified reference URI and stores it in this RDF data model.
	...
	/**
	 * Creates a resource with the provided reference URI and type URI. The given type type URI will be used to attempt to locate a resource factory to create the
	 * resource. A type property with the given type URI will be added to the resource.
	 * <p>
	 * This method knows how to create the following RDF-defined resources:
	 * </p>
	 * <ul>
	 ...
	 * </ul>
	 * <p>
	 * The created resource will be stored in this RDF data model.
	 * </p>
	 * @param referenceURI The reference URI of the resource to create, or <code>null</code> if the resource created should be represented by a blank node.
	 * @param typeURI The URI of the type, or <code>null</code> if the type is not known.
	...
	/**
	 * Creates a resource with the provided reference URI. The given type XML namespace URI and type XML local name will be used to attempt to locate a resource
	 * factory to create the resource. A type property derived from the specified type namespace URI and local name will be added to the resource.
	 * <p>
	 * This method knows how to create the following RDF-defined resources:
	 * </p>
	 * <ul>
	...
	/**
	 * Attempts to create a resource with the provided reference URI The given type URI will be used to attempt to locate a resource factory to create the
	 * resource.
	 * <p>
	 * The created resource, if any, will be added to this RDF data model, but no type will be added to the resource.
	 * </p>
	 * <p>
	 * This method knows how to create the following RDF-defined resources:
	 * </p>
	 ...
	 * @param referenceURI The reference URI of the resource to create, or <code>null</code> if the resource created should be represented by a blank node.
	 * @param typeURI The URI of the type, or <code>null</code> if the type is not known.
	 * @return The resource created with this reference URI, or <code>null</code> if the resource could not be created from a resource factory or a suitable
	...
	/**
	 * Attempts to create a resource with the provided reference URI The given type namespace URI and type local name will be used to attempt to locate a resource
	 * factory to create the resource.
	 * <p>
	 * The created resource, if any, will be added to this RDF data model, but no type will be added to the resource.
	 * </p>
	 * <p>
	...
	/**
	 * Creates a typed literal from the provided lexical form and datatype. The determined datatype namespace URI from the given datatype URI will be used to
	 * attempt to locate a typed literal factory to create the typed literal.
	 * <p>
	 * If no typed literal resource factory can be found, a generic <code>RDFTypedLiteral</code> will be created using the lexical form as the object.
	 * </p>
	 * <p>
	 * This method knows how to create the following RDF-defined typed literals:
	 * </p>
	 * <ul>
	 ...
	 * @return The typed literal with the given datatype with a value created by a lexical form to value mapping.
	 */
	...
	/**
	 * Looks at all the resources in the RDF data model and recursively gathers which resources reference which other resources.
	 * <p>
	 * Circular references are correctly handled.
	 * </p>
	 * @return A map that associates, for each resource, a set of all resources that reference the that resource. Both the map and the associated set use identity
	 *         rather than equality to store resources, as some resources may be anonymous.
	 */
	 ...
	 * Circular references are correctly handled.
	 * </p>
	 * @param referenceMap A map that associates, for each resource, a set of all resources that reference the that resource.
	 * @return The map of resources and associated referring resources. The associated set will use identity rather than equality to store resources, as some
	...
	/**
	 * Looks at the resources and all its properties and recursively gathers which resources reference which other resources.
	 * <p>
	 * Circular references are correctly handled.
	 * </p>
	 * @param resource The resource for which references should be gathered for the resource and all resources that are property values of this resource's
	 ...
	 *          properties, and so on.
	 * @param referenceMap A map that associates, for each resource, a set of all resources that reference the that resource.
	 * @param referrerResourceSet The set of referrers the properties of which have been traversed, the checking of which prevents circular reference problems.
	 * @return The map of resources and associated referring resources. The associated set will use identity rather than equality to store resources, as some
	 *         resources may be anonymous.
	 */
	protected static Map<RDFResource, Set<RDFResource>> getReferences(final RDFResource resource, final Map<RDFResource, Set<RDFResource>> referenceMap,
