...
//G***del System.out.println("XMLPrimitiveValue.createPrimitiveValue() starts with a digit");	//G***del
				final int typeCharIndex=StringUtilities.notCharIndexOf(valueString, NUMBER_CHARS, 0);	//find the first character that isn't a digit or a decimal point G***use a constant here
