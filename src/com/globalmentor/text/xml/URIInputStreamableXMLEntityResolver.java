...
/**An entity resolver that retrieves XML entities from a {@link URIInputStreamable}.
This implementation looks up and returns special predefined entities locally instead of actually retrieving them from the {@link URIInputStreamable}.
...
public class URIInputStreamableXMLEntityResolver extends XMLEntityResolver
{
	...
	protected URIInputStreamable getSource() {return source;}
	...
	*/
	...
	<p>This method delegates to the source {@link URIInputStreamable} if the parent version cannot resolve the entity.
