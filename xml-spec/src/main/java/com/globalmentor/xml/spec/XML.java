...
public class XML {
	...
	public static final ContentType CONTENT_TYPE = ContentType.of(ContentType.TEXT_PRIMARY_TYPE, "xml");
	 ...
	 */
	public static final ContentType EXTERNAL_PARSED_ENTITY_CONTENT_TYPE = ContentType.of(ContentType.TEXT_PRIMARY_TYPE, "xml-external-parsed-entity");
