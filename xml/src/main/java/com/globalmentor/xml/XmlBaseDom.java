...
public class XmlBaseDom {
	 ...
	 * @param element The element for which the <code>xml:base</code> attribute value should be returned.
	...
	public static String getXMLBaseAttributeValue(final Element element) {
		return findAttributeNS(element, XML_NAMESPACE_URI_STRING, ATTRIBUTE_BASE).orElse(null); //return the xml:base attribute value, if it exists TODO propagate Optional
	}

	/**
	 * Retrieves the base URI of the given element by traversing up the element heirarchy to resolve the first specified <code>xml:base</code>. If no base URI is
	 * specified, this method returns <code>null</code>.
	 * @param element The element for which a base URI should be determined.
	 * @return The resolved base URI for the element according to XML Base, or <code>null</code> if a base URI is not specified.
	...
	/**
	 * Retrieves the base URI of the given element by traversing up the element heirarchy to resolve the first specified <code>xml:base</code>. The given URI is
	 * considered to be the base URI of the document, and will be used to resolve fragment base URIs or will be returned if no base URI is specified.
	 * @param element The element for which a base URI should be determined.
	 * @param documentBaseURI The base URI of the document itself, or <code>null</code> if the base URI of the document is not known.
	 * @return The resolved base URI for the element according to XML Base, or the document base URI if a base URI is not specified.
	 * @throws URISyntaxException Thrown if the constructed URI is invalid.
	 */
	...
	/**
	 * Creates a URI by resolving the given URI relative to the base URI of the provided element.
	...
	/**
	 * Creates a URI by resolving the given string relative to the base URI of the provided element.
	...
	/**
	 * Creates a URI by resolving the given string relative to the base URI of the provided element, taking into account the given base URI of the document.
	 * @param string The string to resolve.
	 * @param element The element for which a base URI should be determined.
	 * @param documentBaseURI The base URI of the document itself, or <code>null</code> if the base URI of the document is not known.
	 * @return A URI resolved to the base URI of the document for the given element.
