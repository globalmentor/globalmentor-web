...
public class XMLNamespaceLabelManager extends AbstractNamespaceLabelManager {
	...
	/**
	 * Determines whether the given string is a valid label This version determines whether the string is valid XML name.
	 ...
	 * @see com.globalmentor.w3c.spec.XML#isName(String)
	 */
